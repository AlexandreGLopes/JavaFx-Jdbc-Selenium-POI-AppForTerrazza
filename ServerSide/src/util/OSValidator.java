...
public class OSValidator {
	...
	// Método principal, que vai retornar a String usdada para definir qual
	// webdriver usar
	public static String defineChromedriver() {
		if (isWindows()) {
			return "chromedriver.exe";
		} else if (isMac()) {
			return "Seu sistema operacional não é suportado por esta aplicação";
		} else if (isUnix()) {
			return "chromedriver97";
		} else if (isSolaris()) {
			return "Seu sistema operacional não é suportado por esta aplicação";
		} else {
	...
	// Métodos que leem a string e retornam os booleanos para testarmos o sistema
	// operacional
